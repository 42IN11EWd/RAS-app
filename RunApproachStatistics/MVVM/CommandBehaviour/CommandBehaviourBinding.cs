...
namespace RunApproachStatistics.MVVM.CommandBehaviour
{
    ...
    /// </summary>
    public class CommandBehaviourBinding : IDisposable
    {
        #region Properties
        /// <summary>
        ...
        public ICommand Command
        {
            ...
            set
            {
                ...
                strategy = new CommandExecutionStrategy { behaviour = this };
            }
        }
        ...
        public Action<object> Action
        {
            ...
            set
            {
                ...
                strategy = new ActionExecutionStrategy { behaviour = this };
            }
        }
        #endregion
        ...
        public void BindEvent(DependencyObject owner, string eventName)
        {
            ...
            EventHandler = EventHandlerGenerator.CreateDelegate(
                Event.EventHandlerType, typeof(CommandBehaviourBinding).GetMethod("Execute", BindingFlags.Public | BindingFlags.Instance), this);
